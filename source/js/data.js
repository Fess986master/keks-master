// блок генерации случайных объявлений. В проекте не используем, так как данные получаем по сети
...
//   adress = 'location1 x = ' + randomFloating(1, 100, 5) + ' location1 y = ' + randomFloating(1, 100, 5);
// }
